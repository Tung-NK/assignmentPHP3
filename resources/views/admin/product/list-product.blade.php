                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="avatar-md bg-success bg-opacity-10 rounded">
                                            <iconify-icon icon="iconamoon:link-external-duotone"
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="avatar-md bg-danger bg-opacity-10 rounded">
                                            <iconify-icon icon="iconamoon:trend-up-bold"
                ...
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        <div class="row align-items-center">
                            <div class="col-lg-7">
                                <div id="world-map-markers" class="my-3" style="height: 300px"></div>
                            </div>
                            <div class="col-lg-5" dir="ltr">
                                <div class="p-3">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <p class="mb-1">
                                            <iconify-icon icon="circle-flags:br"
                                                class="fs-16 align-middle me-1"></iconify-icon>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-nowrap table-centered m-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <a href="#" class="text-muted">reback/dashboard.html</a>
                                    </td>
                                    <td>4265</td>
                                    <td>09m:45s</td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <a href="#" class="text-muted">reback/chat.html</a>
                                    </td>
                                    <td>2584</td>
                                    <td>05m:02s</td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <a href="#" class="text-muted">reback/auth-login.html</a>
                                    </td>
                                    <td>3369</td>
                                    <td>04m:25s</td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <a href="#" class="text-muted">reback/email.html</a>
                                    </td>
                                    <td>985</td>
                                    <td>02m:03s</td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <a href="#" class="text-muted">reback/social.html</a>
                                    </td>
                                    <td>653</td>
                                    <td>15m:56s</td>
                                    <td>
